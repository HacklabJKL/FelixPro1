...
#define EEPROM_MODE 4 // New set because of jerk and travel adaptation
#undef PS_ON_PIN
#define PS_ON_PIN -1
...
#define Z_PROBE_MIN_TEMPERATURE 185
...
#define BED_MOTOR_2_Y 46
#define BED_MOTOR_3_X 137
#define BED_MOTOR_3_Y 212
...
#define MOTOR_DRIVER_1(var) StepperDriver<51,53,49,0,0> var(3382,0.4)
#define MOTOR_DRIVER_2(var) StepperDriver<39,13,40,0,0> var(3382,0.4)
...
========== Start configuration string ==========
{
    ...
    "motorDrivers": [
        {
            "t": "Stepper",
            "s": "StepperDriver<51,53,49,0,0> var(3382,0.4)",
            "invertEnable": "0",
            "invertDirection": "0",
            "stepsPerMM": 3382,
            "speed": 0.4,
        ...
        {
            "t": "Stepper",
            "s": "StepperDriver<39,13,40,0,0> var(3382,0.4)",
            "invertEnable": "0",
            "invertDirection": "0",
            "stepsPerMM": 3382,
            "speed": 0.4,
